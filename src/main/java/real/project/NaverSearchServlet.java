...
/*
	어노테이션을 통한 요청명 매핑
	(항상 컨텍스트 루트 경로를 제외한 /로 시작하는 경로명을 써야함)
 */
...
public class NaverSearchServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// 네이버 개발자센터에서 발급받은 API Key입력
		String clientId = "P6T8ZTpkqj7d6xMrZ1qz"; //애플리케이션 클라이언트 아이디값"
        String clientSecret = "8xBXXaOTUT"; //애플리케이션 클라이언트 시크릿값"
        ...
        // 검색API의 요청 URL
        /*
        	파라미터 설명 (API Document 참조)
        		query : 검색어 (필수사항)
        		display : 출력할 결과의 개수 (디폴트 : 10개)
