...
public class MemberAuth extends HttpServlet {
	...
	public void init() throws ServletException {
		/*
			...
			모델2 방식에서는 서블릿이 먼저 요청을 받기 때문에
			모델1 방식과 같이 JSP에서 매개변수 형태로 내장객체를 전달할 수 없다.
			따라서 각 내장객체를 얻어올 수 있는 메소드가 존재한다.
		 */
	...
	/*
		service() 메소드는 get방식, post방식 두가지 요청을 모두 받을 수 있으므로
