...
<body>
	...
	<!-- 
		...
		따라서 스크립트릿(<% %>)에서 선언한 변수는 EL에서 사용할 수 없다.
	 -->
	스크립틀릿에서 선언한 변수 : ${ num1 } <!-- 아무값도 출력되지 않음 --><br>
	page 영역에 저장된 변수 : ${ num2 } <br>
	<!-- 
		Tomcat8.0부터는 EL에서 변수할당을 할 수 있다.
		변수 할당과 동시에 출력되므로 차후에 출력하고자 한다면
		할당문 뒤에 ;''을 붙여야 바로 출력되지 않는다.
	 -->
	변수 할당 및 즉시 출력 : ${ num1 = 7 } <br>
	변수 할당 빛 별도 출력 : ${ num2 = 8;'' } => ${ num2 } <br>
	...
	num1 - num2 : ${ num1 - num2 } <br>
	num1 * num2 : ${ num1 * num2 } <br>
	<!-- EL은 자동형변환이 적용되므로 정수와 정수의 연산에 실수의 결과가 나올수 있다. -->
