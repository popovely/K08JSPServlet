...
<body>
	...
	<h3>지시어로 페이지 포함하기</h3>
	<!-- 
		지시어의 경우 페이지의 경로를 문자열의 형태로만 기술할 수 있고,
		표현식은 사용할 수 없다.
	 -->
	...
	<!-- 
		지시어를 통한 include는
		포함할 파일의 소스 자체를 그대로 현재 문서에 포함시킨 후,
		컴파일을 진행한다.
	...
	<!-- 
		액션태그의 경우 문자열과 표현식 둘 다 사용가능
	 -->
	<jsp:include page="./inc/OuterPage2.jsp" />
	<jsp:include page="<%=outerPath2%>"></jsp:include>
	<!-- 
		액션태그를 통한 include는
		포함할 파일을 먼저 컴파일(실행)한 후,
	...
	액션태그
		...
		- 하지만 forward처럼 하나의 요청을 공유하는경우 request영역은 공유된다.
	 -->
</body>
</html>