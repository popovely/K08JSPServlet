...
scope
	: 4가지 영역명을 지정.
	  미지정시 page영역으로 지정됨.
target
	: set태그를 통해 생성된 자바빈즈의 이름을 지정함.
property
	: target으로 지정한 자바빈즈의 멤버변수(property)값 설정함.
 -->
<body>
	<!-- set태그를 이용한 변수선언 -->
	...
	<c:set var="betweenVar">변수값 이렇게 설정!</c:set><!-- 4.시작태그와 종료태그 사이에 value지정 -->
	<!-- scope속성을 생략했으므로 가장 좁은 영역 page영역에 변수 저장됨. -->
